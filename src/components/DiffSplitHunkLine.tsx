import { DiffFile, composeLen } from "../diff";
...
export const DiffSplitHunkLine = ({
  ...
  const currentIsShow =
    currentHunk &&
    currentHunk.splitInfo.startHiddenIndex <
      currentHunk.splitInfo.endHiddenIndex;
    ...
    >
      <td
        ...
        style={{
          ...
          backgroundColor:
            side === SplitSide.old ? `var(${hunkLineNumberBGName})` : undefined,
...
export const DiffSplitExpandLastLine = ({
  diffFile,
  isWrap,
  side,
}: {
