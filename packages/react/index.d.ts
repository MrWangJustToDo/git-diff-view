 ...
 * ```
 */
export declare function useMultiSelect(containerRef: RefObject<HTMLElement | null>, diffFile: DiffFile | null, options?: UseMultiSelectOptions): {
	getSelectionResult: () => MultiSelectResult;
	getState: () => MultiSelectState;
	clearSelection: () => void;
	setPreselectedLines: (lines: {
		old: number[];
