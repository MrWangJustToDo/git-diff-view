...
declare function diff(text1: string, text2: string, cursorPos?: number | diff.CursorInfo, cleanup?: boolean): diff.Diff[];
...
export declare class DiffLine {
	...
	range?: IRange;
	diffRange?: DiffRange;
	constructor(text: string, type: DiffLineType, originalLineNumber: number | null, oldLineNumber: number | null, newLineNumber: number | null, noTrailingNewLine?: boolean, needRematch?: boolean, range?: IRange, diffRange?: DiffRange);
...
export declare function diffChanges(addition: DiffLine, deletion: DiffLine): {
	stringARange: DiffRange;
	stringBRange: DiffRange;
};
/**
...
export interface DiffRange {
	readonly range: ReturnType<typeof diff>;
