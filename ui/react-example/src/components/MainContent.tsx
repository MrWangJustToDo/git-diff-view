...
export const MainContent = () => {
  ...
  return (
    <Flex mt="lg" direction={{ base: "column", sm: "row" }}>
      ...
      <Box
        className={`relative h-[calc(100vh-200px)] overflow-auto rounded-md border border-solid ${colorScheme === "light" ? "border-gray-200" : "border-gray-600"}`}
        w={{ base: "100%", sm: "60%" }}
      >
        ...
        <DiffViewWithScrollBar
                      ...
                      <CloseButton
                        ...
                        onClick={() => {
                          setExtend((prev) => {
                            ...
                            res[sideKey] = {
                              ...res[sideKey],
                              [lineNumber]: { data: res[sideKey]?.[lineNumber].data.filter((_, index) => index !== i) },
                            };
                            return res;
                          });
                        }}
          ...
          // for this example, we always use a new diffFile instance to make code clean
